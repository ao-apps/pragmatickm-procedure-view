 ...
 * along with pragmatickm-procedure-view.  If not, see <https://www.gnu.org/licenses/>.
 */

package com.pragmatickm.procedure.view.book;
 ...
 */
@WebServlet("/procedure/view/apidocs/com/*")
public class ModularApidocsRedirect extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    HttpServletUtil.sendRedirect(
        ...
        "/procedure/view/apidocs/com.pragmatickm.procedure.view/com" + Objects.toString(req.getPathInfo(), ""),
